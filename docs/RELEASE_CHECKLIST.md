...
- [ ] Tape Machine rejects empty, unsupported, oversized, and over-three-minute audio with useful errors
...
- [ ] Three-minute audio remains usable, one AudioContext is reused, and old buffers/nodes are released
